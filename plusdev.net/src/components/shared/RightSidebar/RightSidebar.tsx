...
const topPosts: any = [
	{
		id: 1,
		title: 'Mastering Smart Contract Development with Node.js: Tools, Security, and Best Practices',
	...
	{
		id: 2,
		title: 'Asynchronous Programming in Node.js: Callbacks, Promises, and Async/Await Explained',
		image: 'https://www.plusdev.net/_next/image?url=https%3A%2F%2Fplusdev-net.s3.eu-central-1.amazonaws.com%2Fbd1c1480201129be867adf88effb1458_nodejs-smart-contracts.jpg&w=640&q=60',
		url: '/posts/test',
	},
	{
		id: 3,
		title: 'Node.js vs. Golang: An In-Depth Comparison of the Latest Versions in 2024',
		image: 'https://www.plusdev.net/_next/image?url=https%3A%2F%2Fplusdev-net.s3.eu-central-1.amazonaws.com%2Fbd1c1480201129be867adf88effb1458_nodejs-smart-contracts.jpg&w=640&q=60',
		url: '/posts/test',
	},
	{
		id: 4,
		title: 'Mastering Concurrency in Go: A Comprehensive Guide to Goroutines and Channels',
		image: 'https://www.plusdev.net/_next/image?url=https%3A%2F%2Fplusdev-net.s3.eu-central-1.amazonaws.com%2Fbd1c1480201129be867adf88effb1458_nodejs-smart-contracts.jpg&w=640&q=60',
		url: '/posts/test',
	},
];
...
const hotQuestions: any = [
	{
		id: 1,
		title: 'Is there a way in Golang to define a generic function type with varargs that can take any function as input?',
		url: '/questions/test',
	},
	{
		id: 2,
...
const RightSidebar = () => {
    ...
    p-6 pt-36 max-xl:hidden'>
			...
			<div className='mt-16'>
				<h3 className='h3-bold text-zinc-900 dark:text-zinc-200'>Popular Tags</h3>
