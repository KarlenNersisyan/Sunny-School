...
const RenderTag = ({ id, title, url, totalCount, showCount, className }: Props) => {
	return (
		<Link
			to={url}
			...
			{showCount && <span className='small-medium text-zinc-700 dark:text-zinc-400'>{totalCount}</span>}
		</Link>
	);
};
