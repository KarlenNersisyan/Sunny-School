...
import { LucideNewspaper, LucidePlusSquare, LucideShieldQuestion, LucideMenu } from 'lucide-react';
	...
	return (
		<nav className='fixed p-5 z-50 flex w-full items-center justify-between gap-3 bg-zinc-50 shadow-sm sm:px-12 dark:bg-zinc-900 dark:shadow-black'>
			...
			<div className='flex items-center justify-between gap-5'>
				...
				<LucideMenu className='lucide lucide-menu h-7 w-7 text-red-600 hover:cursor-pointer sm:hidden dark:text-red-500' />
			</div>
		</nav>
	);
};
