          ...
          uppercase tracking-wide text-zinc-600 dark:text-zinc-400'>
				...
				<div className='flex gap-4'>
					<Link
						...
						<Button className='btn-secondary min-h-[46px] px-4 py-3 text-zinc-50 max-sm:min-w-[150px]'>Create a Post</Button>
					</Link>
					<Link
						to='/ask-question'
						className='flex justify-end'>
						<Button className='btn-tertiary min-h-[46px] px-4 py-3 text-zinc-50 max-sm:min-w-[150px]'>Ask a Question</Button>
					</Link>
				</div>
			</div>
